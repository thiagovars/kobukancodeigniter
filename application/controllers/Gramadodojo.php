...
class Gramadodojo extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array(
			...
			'title' => 'Dojo Gramado ',
			'title_treino_alternativo' => '<h2 class="shorter">Horários para treino <h3 class="shorter"><strong>Iaido</strong></h3></h2>',
			...
			'horarios_treino' => array(
				...
				'Quartas'  => array('hora' => '20h00 - 22h00', 'instrutor' => 'Jordan T. Nicloti'),
			),
			'responsaveis' => array(
