...
<!-- Libs -->
		...
		<!-- Current Page JS -->
		<script src="<?php echo base_url();?>vendor/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
		<script src="<?php echo base_url();?>vendor/rs-plugin/js/jquery.themepunch.revolution.js"></script>
