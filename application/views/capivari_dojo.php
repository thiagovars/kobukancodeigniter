							...
							<ul class="lightbox" data-plugin-options='{"delegate": "a", "type": "image", "gallery": {"enabled": true}}'>
								<li class="col-md-4	 no-pin isotope-item">
									<div class="portfolio-item img">
										<a href="/kobukan/img/capivari/fachada.jpg" class="thumb-info">
											<img src="/kobukan/img/capivari/fachada.jpg" class="100Width image-responsive" height="365">
										</a>
									</div>
								</li>
							</ul>
							...
							<li class="col-md-3 isotope-item leadership">
								<div class="team-item thumbnail">
									<span class="thumb-info team">
										<img class="img-responsive" alt="" src="/kobukan/img/team/samuel.jpg">
							...
							<ul class="lightbox" data-plugin-options='{"delegate": "a", "type": "image", "gallery": {"enabled": true}}'>
								<li class="col-md-3 no-pin isotope-item">
									<div class="portfolio-item img-thumbnail">
										<a href="/kobukan/img/capivari/imagem8.jpg" class="thumb-info">
											<img src="/kobukan/img/capivari/imagem8.jpg" class="image-responsive" height="200" width="400">
										</a>
									</div>
								</li>
								<li class="col-md-3 no-pin">
									<div class="img-thumbnail">
										<a href="/kobukan/img/capivari/dojo.jpg" class="thumb-info">
											<img src="/kobukan/img/capivari/dojo.jpg" class="image-responsive"  height="200" width="400">
										</a>
									</div>
								</li>
								<?php 
									...
									<li class="col-md-3 no-pin">
										<div class="img-thumbnail">
											<a href="/kobukan/img/capivari/<?php echo $foto;?>" class="thumb-info">
												<img src="/kobukan/img/capivari/<?php echo $foto;?>" class="image-responsive"  height="200" width="400">
											</a>
										</div>
									</li>
								<?php endforeach; ?>
