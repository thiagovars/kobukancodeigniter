				...
				<div class="container">
					...
					<div class="row center">
						<div class="col-md-12 text-align-center">
							<img class="img-responsive margin-auto" src="/kobukan/img/ivoti/logo.png" width="150" alt="">
							...
							<li class="col-md-3 isotope-item leadership">
								<div class="team-item thumbnail">
									<span class="thumb-info team">
										<img class="img-responsive" alt="" src="/kobukan/img/team/valim.jpg">
								...
								<?php foreach ($fotos as $foto) :?>
									<li class="col-md-3 no-pin">
										<div class="img-thumbnail">
											<a href="/kobukan/img/ivoti/<?php echo $foto; ?>" class="thumb-info">
												<img src="/kobukan/img/ivoti/<?php echo $foto; ?>" class="image-responsive"  height="200" width="400">
											</a>
										</div>
									</li>
									<?php endforeach; ?>
