							...
							<ul class="lightbox" data-plugin-options='{"delegate": "a", "type": "image", "gallery": {"enabled": true}}'>
								<li class="col-md-4	 no-pin isotope-item">
									<div class="portfolio-item img">
										<a href="/kobukanimg/imbituba/fachada.jpg" class="thumb-info">
											<img src="/kobukan/img/imbituba/fachada.jpg" id="imbitubaFachada" class="100Width image-responsive" height="365">
										</a>
									</div>
								</li>
							</ul>
							...
							<li class="col-md-3 isotope-item leadership">
								<div class="team-item thumbnail">
									<span class="thumb-info team">
										<img class="img-responsive" alt="" src="/kobukan/img/team/vinicius.jpg">
								...
								<?php foreach ($fotos as $foto) : ?>
									<li class="col-md-3 no-pin">
										<div class="img-thumbnail">
											<a href="/kobukan/img/imbituba/<?php echo $foto; ?>" class="thumb-info">
