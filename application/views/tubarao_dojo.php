					...
					<div class="row">
						...
						<ul class="team-list sort-destination" data-sort-id="team">
							<li class="col-md-3 isotope-item leadership">
								<div class="team-item thumbnail">
									<span class="thumb-info team">
										<img class="img-responsive" alt="" src="/kobukan/img/team/fabricio.jpg">
							...
							<li class="col-md-3 isotope-item marketing">
								<div class="team-item thumbnail">
									<span class="thumb-info team">
										<img class="img-responsive" alt="" src="/kobukan/img/team/natalia.jpg">
										<span class="thumb-info-title">
								...
								<?php foreach ($fotos as $foto) :?>
									<li class="col-md-3 no-pin isotope-item">
										<div class="portfolio-item img-thumbnail">
											<a href="/kobukan/img/tubarao/<?php echo $foto; ?>" class="thumb-info">
												<img src="/kobukan/img/tubarao/<?php echo $foto; ?>" class="image-responsive" height="200" width="400">
											</a>
										</div>
									</li>
								<?php endforeach; ?>
