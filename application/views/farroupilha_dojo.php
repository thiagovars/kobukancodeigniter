								...
								<ul class="lightbox" data-plugin-options='{"delegate": "a", "type": "image", "gallery": {"enabled": true}}'>
									...
									<li class="col-md-3 no-pin isotope-item">
										<div class="portfolio-item img-thumbnail">
											<a href="/kobukan/img/farroupilha/<?php echo $foto;?>" class="thumb-info">
												<img src="/kobukan/img/farroupilha/<?php echo $foto;?>" class="image-responsive" height="200" width="400">
											</a>
										</div>
									</li>
