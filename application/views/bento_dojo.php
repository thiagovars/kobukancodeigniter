					...
					<div class="row">
						...
						<ul class="team-list sort-destination" data-sort-id="team">
							...
							<li class="col-md-3 isotope-item leadership">
								<div class="team-item thumbnail">
									<span class="thumb-info team">
										<img class="img-responsive" alt="" src="/kobukan/img/team/ze.jpg">
										<span class="thumb-info-title">
									...
									<li class="col-md-3 no-pin isotope-item">
										<div class="portfolio-item img-thumbnail">
											<a href="img/bento/inauguracao_bento.jpg" class="thumb-info">
												<img src="/kobukan/img/bento/inauguracao_bento.jpg" class="image-responsive" height="200" width="400">
											</a>
										</div>
									</li>
									<li class="col-md-3 no-pin isotope-item">
										<div class="portfolio-item img-thumbnail">
											<a href="img/bento/bento2.jpg" class="thumb-info">
												<img src="/kobukan/img/bento/bento2.jpg" class="image-responsive" height="200" width="400">
											</a>
										</div>
									</li>
								</ul>
